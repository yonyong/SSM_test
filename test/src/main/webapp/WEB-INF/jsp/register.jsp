...
<head>
    ...
    <link href="<%=basePath %>static/bootstrap-3.3.7-dist/css/bootstrap.min.css" rel="stylesheet"></head>
<body>
<br/><br/><br/><br/><br/><br/><br/>
<div class="row">
    <div class="col-md-2"></div>
    <div class="col-md-4"><img src="<%=basePath %>/static/register.png" width="420"
                               height="330">
    </div>
    <div class="col-md-3">
        ...
        <form id="myform">
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox"> 我已阅读并同意<a href="success">《用户注册协议》</a>
                </label>
            </div>
            <div class="form-group">
...
<script type="text/javascript" src="<%=basePath %>static/register.js"></script>
<script>
    //手机验证码
